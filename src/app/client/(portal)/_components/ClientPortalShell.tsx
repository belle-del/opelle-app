  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#F7F4EF" }}>
      ...
      <main
        ...
        style={{ paddingTop: "60px", paddingBottom: "72px", maxWidth: "500px" }}
      >
      ...
      >
        <div className="px-5 py-4">
          ...
          <button
            ...
            className="flex items-center gap-3 py-3.5 px-3 rounded-xl w-full text-left"
            style={{
              background: "none",
              border: "none",
              color: "#9E5A5A",
          ...
          if (tab.href === "#more") {
            return (
              <button
                ...
                className="flex flex-col items-center gap-1 min-w-[60px] min-h-[48px] justify-center"
